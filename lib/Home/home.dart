...
import 'package:harekrishnagoldentemple/Books/Book_Category.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _redirectToPageTwo(String route, String dropdown_item) async {
    if (route == "Ekadashi") {
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => const PrabhupadaFeeds()));
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => const PrabhupadaQuotes()));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 9,
        toolbarHeight: 50,
        backgroundColor: true ? Colors.orange.shade500 : white,
        title: Column(
          ...
          IconButton(
            ...
            onPressed: () async {
              await FlutterShare.share(
                 linkUrl: "https://play.google.com/store/apps/details?id=com.hkmhyderabad.harekrishnagoldentemple", title: '');
            },
          ),
        ],
      ),
          ...
          children: [
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  sevaCard1(
                      "https://www.mudkart.com/s/6102abc4ca6399195948940e/61239cb7aa9d4b578ecfbba4/hundi-04.jpg",
                      "Sudhama Seva",
                      "If someone gives something to the Lord, he is not the loser; he is the gainer",
                      "100",
                      context),
  ...
  Widget yatraCard(String image, title, ratting, id, int discount,
  ...
  Widget sevaCard1(String image, title, caption, id, BuildContext context) {
    ...
    void handlePaymentSuccessResponse(PaymentSuccessResponse response) {
      ...
      Navigator.of(context)
          .push(MaterialPageRoute(builder: ((context) => const YourSevaList())));

      print("success");
    }

    void handleExternalWalletSelected(ExternalWalletResponse response) {
      print("walletSelected");
    }
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () async {
                                                  ...
                                                  var options = {
                                                    ...
                                                    'description':
                                                        'Donating Sudhama Seva to Hare Krishna Movement',
                                                    'retry': {
                                                      'enabled': true,
                                                      'max_count': 10
                                                    },
