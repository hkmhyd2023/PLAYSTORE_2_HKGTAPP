  ...
  late YoutubePlayerController _controller;
    try {
      ...
      if (userSnapshot.exists) {
        ...
        String dropdown_item = initialMessage.data['Dropdown_Item'];
if (route == "Ekadashi") {
      ...
      Navigator.push(
          navigatorKey.currentContext!, MaterialPageRoute(builder: (context) => JapaPage()));
    } else if (route == "Live") {
      showDialog(
      ...
      Navigator.push(
          navigatorKey.currentContext!, MaterialPageRoute(builder: (context) => const Darshans()));
  ...
  } else if (route == 'Chaitanya_MahaPrabhu') {
    
      Navigator.push(
          navigatorKey.currentContext!,
          MaterialPageRoute(
              builder: (context) => ChaitanyaMahaPrabhuFeeds()));
  }
